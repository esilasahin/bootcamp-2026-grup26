...
export default function DashboardApp({ currentUser, onLogout }) {
  const displayName = currentUser?.fullName || "UniMate Kullanıcısı";
    ...
    <div className="app-container">
      ...
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .logout-button { border: none; background: #fee2e2; color: #b91c1c; padding: 8px 12px; border-radius: 999px; font: inherit; font-size: 12px; font-weight: 600; cursor: pointer; transition: background 0.2s; }
